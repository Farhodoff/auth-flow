import { Shield, Database, Zap, Globe, Code2 } from "lucide-react";

export default function Features() {
    const features = [
        {
            title: "Secure Authentication",
            desc: "Enterprise-grade security with JWT and 2FA support. Google, GitHub, and Email providers.",
        ...
        {
            title: "Edge Ready",
            desc: "optimized for lightning-fast performance globally.",
        ...
        {
            title: "Modern Stack",
            desc: "Vite, React, Tailwind CSS, and Framer Motion.",
