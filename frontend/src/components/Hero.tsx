        ...
        <div className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-foreground mb-8 text-balance bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text">
                    The <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">Ultimate Auth Starter</span> <br className="hidden md:block" /> for React Developers
                </h1>
